...
CW_DLL_SPEC AreaTableEntry const* GetAreaEntryByAreaID(uint32 area_id);
CW_DLL_SPEC AreaTableEntry const* GetAreaEntryByAreaFlagAndMap(uint32 area_flag,uint32 map_id);
